        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ingresar Color</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="p-4" method="POST" action="index.php?c=color&a=agregar">
                        <div class="mb-3">
    ...
    <div class="modal fade" id="exampleModalEditar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="p-4" method="POST" action="index.php?c=Color&a=editar">
                        <div class="mb-3">
                            <label class="form-label">Codigo</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Color</label>
                            <input type="text" class="form-control" id="txtColorEditar" name="txtColor" autofocus required>
                ...
                <div class="p-4">
                    <div class="filtro d-flex justify-content-between">
                        ...
                        <form id="frmSearch" class="d-flex">
                            <input type="text" placeholder="Color" size="" class="form-control" id="txtBuscar" name="txtBuscar">
                            <button id="color" class="btn btn-primary d-flex" style="margin-left:10px;" type="submit" name="base"> <i class="bi bi-search px-1"></i> Buscar</button>
                        </form>
                    </div>
                    <hr>
                        ...
                        <tbody id="tblDatos">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a onclick="return confirm('Estas seguro de eliminar?');" class="btn btn-danger " href="index.php?c=Color&a=eliminar&id=<?php echo $dato->id; ?>"><i class="bi bi-trash"></i></a></td>
                                </tr>
                            <?php
                            }
                            ?>
...
<script>
        ...
        if (json.status) {
            ...
            data.forEach((item) => {
                ...
                newtr.innerHTML = `<tr>
                                           ...
                                           <td><a onclick="return confirm('Estas seguro de eliminar?');" class="btn btn-danger " href="index.php?c=Color&a=eliminar&id=${item.id}"><i class="bi bi-trash"></i></a></td>
                                           </tr>
                                           `;
    ...
    function mostrarDatoEncontrado(json) {
        if (json.status) {
            ...
            document.querySelector("#txtColorEditar").value = data.color;
    ...
    function mensajeRegistrado() {
        swal({
            ...
            text: "¡El color ha sido registrado correctamente!",
            icon: "success",
        }).then((value) => {
            window.location.replace("index.php?c=Color&a=index");
        });;
    }
    ...
    function mensajeActualizado() {
        swal({
            ...
            text: "¡El color ha sido editado correctamente!",
            icon: "success",
        }).then((value) => {
            window.location.replace("index.php?c=Color&a=index");
        });;
